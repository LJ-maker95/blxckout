    ...
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex flex-col">
        ...
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div>
            <h1 className="text-4xl text-center px-20">We're building a world class community of <span className="font-bold text-transparent bg-clip-text bg-gradient-to-tr from-[#9945FF] to-[#14F195]">art lovers</span>.</h1>
            <p className="py-6 text-center px-20"> A collection of 2222 satirical and thought-provoking fine art PFP NFT’s on the Solana blockchain. We're a team of experienced technology and marketing professionals trying to change the status quo and perception of nfts.</p>
            <button className="btn text-center btn-primary">Check BLXCKMXP</button>
          </div>
        </div>
        </div>
        <div className="text-4xl text-center py-5 px-20">
        ...
        <div className="flex-col text-center px-20">
