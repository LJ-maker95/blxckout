      ...
      <div className="wrapper">
        ...
        <nav className="nav__wrapper" id="navbar-example">
          <ul className="nav">
            ...
            <li role="presentation" className="active">
              <a href="#section1">
                <span className="nav__counter">Q1</span>
        ...
        <section className="section section1" id="section1">
          <div className="flex flex-col border-opacity-50">
            <div className="grid h-20 card rounded-box place-items-center">
              <span className="text-4xl text-transparent bg-clip-text bg-gradient-to-tr from-[#eacda3] to-[#d6ae7b]">Stage 1: Grow the Community.</span>
            </div>
            <div className="divider" />
              <div className="grid h-20 card rounded-box place-items-center">Collaborate with other artists and projects.</div>
          </div>
        </section>
        ...
        <section className="section section2" id="section2">
          <div className="flex flex-col w-mid border-opacity-50">
            <div className="grid h-20 card rounded-box place-items-center">
              <span className="text-4xl text-transparent bg-clip-text bg-gradient-to-tr from-[#eacda3] to-[#d6ae7b]">Stage 2: Staking Go-live.</span>
            </div>
            <div className="divider" />
        ...
        <section className="section section3" id="section3">
          <div className="flex flex-col w-lg border-opacity-50">
            <div className="grid h-20 card rounded-box place-items-center">
              <span className="text-4xl text-transparent bg-clip-text bg-gradient-to-tr from-[#eacda3] to-[#d6ae7b]">Stage 3: Building.</span>
            </div>
            <div className="divider" />
        ...
        <section className="section section4" id="section4">
          <div className="flex flex-col w-mid border-opacity-50">
            <div className="grid h-20 card rounded-box place-items-center">
              <span className="text-4xl text-transparent bg-clip-text bg-gradient-to-tr from-[#eacda3] to-[#d6ae7b]">Stage 4: Building continues.</span>
            </div>
            <div className="divider" />
        ...
        <section className="section section5" id="section5">
          <div className="flex flex-col w-mid border-opacity-50">
            <div className="grid h-20 card rounded-box place-items-center">
              <span className="text-4xl text-transparent bg-clip-text bg-gradient-to-tr from-[#eacda3] to-[#d6ae7b]">Stage 5: NFT Buyback.</span>
            </div>
            <div className="divider" />
        ...
        <section className="section section6" id="section6">
          <div className="flex flex-col w-mid border-opacity-50">
            <div className="grid h-20 card rounded-box place-items-center">
              <span className="text-4xl text-transparent bg-clip-text bg-gradient-to-tr from-[#eacda3] to-[#d6ae7b]">Stage 6: Initial Coin Offering.</span>
            </div>
            <div className="divider" />
              <div className="grid h-20 card rounded-box place-items-center">Build the community.</div>
          </div>
