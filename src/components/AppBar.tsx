...
export const AppBar: FC = props => {
  ...
  return (
    <div>
      ...
      {/* NavBar / Header */}
      <div className="navbar flex flex-row md:mb-2 shadow-lg bg-dark text-neutral-content">
        ...
        {/* Nav Links */}
        <div className="hidden md:inline md:navbar-right">
          <div className="flex items-stretch">
            <Link href="/basics">
              <a className="btn btn-ghost btn-sm rounded-btn">PROJECT</a>
              </Link>
            <Link href="/roadmap">
              <a className="btn btn-ghost btn-sm rounded-btn">BLXCKMAP</a>
            </Link>
            <Link href="/art">
              <a className="btn btn-ghost btn-sm rounded-btn">ART SHOP</a>
            </Link>
            <Link href="/team">
              <a className="btn btn-ghost btn-sm rounded-btn">TEAM</a>
            </Link>
            <Link href="/tech">
